...
double safe_loss_cartpole(double x_inf, double x_sup, double theta_inf, double theta_sup)
{
	...
	double theta_loss = max(my_relu(-1 * theta_inf - 0.20), my_relu(theta_sup - 0.20));
...
int main(int argc, char *argv[])
{
	...
	ifstream dynamics_file("./results/learned_dynamics/Marvelgymnasium_cartpole_move-v1/model.txt");
