...
def config_args():
    ...
    arguments.Config.add_argument('--network_name', type=str, default="nn_6_relu",
...
def main(steps = 5):
    ...
    Xs = np.zeros((steps+1, 8))
    Xs[0] = [x0_min, x0_max, x1_min, x1_max, x2_min, x2_max, x3_min, x3_max]

    for step in range(steps):
        us_min = ctrl_input_bound(model_lb, [x0_min, x1_min, x2_min, x3_min], [x0_max, x1_max, x2_max, x3_max])
        us_max = -ctrl_input_bound(model_ub, [x0_min, x1_min, x2_min, x3_min], [x0_max, x1_max, x2_max, x3_max])
        ...
        command += [str(i) for i in [x0_min, x0_max, x1_min, x1_max, x2_min, x2_max, x3_min, x3_max, u_min, u_max]]
        command += [str(step)]
        ...
        x3_min = x3_range[0]
        x3_max = x3_range[1]
        Xs[step+1] = [x0_min, x0_max, x1_min, x1_max, x2_min, x2_max, x3_min, x3_max]

    fig, ax = plt.subplots()
    for bound in Xs:
        print(bound)
        x0_min, x0_max, x1_min, x1_max, x2_min, x2_max, x3_min, x3_max = bound
