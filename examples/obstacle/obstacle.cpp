...
{	
	...
	string benchmark_name = "obstacle";
	...
	*/
	...
	ifstream dynamics_file("./results/learned_dynamics/Marvelgymnasium_obstacle-v1/model.txt");
...
*/
	...
	vector<vector<double>> unsafe_set = {{0.0, 1.0}, {2.0, 3.0}};
